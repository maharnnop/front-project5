...
<div className="card ">
    ...
    <div className="card-content">
      ...
      <p><Link to={"/packages/"+props.detail.id}>click to Buy</Link></p>
    </div>
    ...
    <Link to={"/packages/"+props.detail.id} className="btn-floating btn-small waves-effect waves-light red"><i class="material-icons">navigate_next</i></Link>
    </div>
  </div>
